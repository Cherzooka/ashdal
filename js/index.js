...
Vue.component('character-component', {
    template: `<slide class="character-container" :style="{borderColor: 'hsl(' + character.color + ')'}"><div class="character" @:click="selectedcharacter = 'character.name'"><img :src="character.img"><div class="content">{{character.name}}</div></div></slide>`,
    props: {
        character: Object
    },
});
...
window.onload = function () {
    var app = new Vue({
        ...
        data: {
            ...
            // Design
            font: "Tuesday-Vibes",
            // Color should be in hsl, without () and hsl tag (And remember to remove the °). Example using white: "217, 0%, 100%",
            color: "208, 13%, 53%",
            ...
            class2: "Warlock",
            class2level: 2,
            proficiencies: "Athletics, Arcana, Perception, Survival, Deception, Persuasion",
